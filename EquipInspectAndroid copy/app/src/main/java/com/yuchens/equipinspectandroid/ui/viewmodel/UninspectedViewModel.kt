...
import com.yuchens.equipinspectandroid.ui.viewmodel.InspectedViewModel.UiState
...
@HiltViewModel
class UninspectedViewModel @Inject constructor(
    ...
    fun load() {
        viewModelScope.launch {
            ...
            runCatching { repo.getEquipUninspected().toUiList() }
                .onSuccess { list ->
